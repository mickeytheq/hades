package com.mickeytheq.hades.codegen;
...
public class GenerateLanguageConstants {
    ...
    private void generateGameResources() {
        Properties properties = loadProperties("/language/Hades-Game.properties");
    ...
    private void generateInterfaceResources() {
        Properties properties = loadProperties("/language/Hades-Interface.properties");
    ...
    private String makeKey(String rawKey) {
        ...
        key = StringUtils.removeStart(key, "HADES_");
    ...
    private File getTargetDirectory() {
        ...
        File targetFile = new File(userDir, "src/main/java/com/mickeytheq/hades/codegenerated/");
