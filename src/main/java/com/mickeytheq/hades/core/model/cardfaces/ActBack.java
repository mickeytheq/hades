...
public class ActBack extends BaseCardFaceModel implements HasCommonCardFieldsModel, HasEncounterSetModel, HasActFieldsModel {
    ...
    public void initialiseNew(ProjectContext projectContext, CardFaceSide cardFaceSide) {
        ...
        getActFieldsModel().setCopyOtherFace(cardFaceSide == CardFaceSide.Back);
