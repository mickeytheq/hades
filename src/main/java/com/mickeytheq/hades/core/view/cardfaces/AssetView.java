...
public class AssetView extends BaseCardFaceView<Asset> implements HasCollectionView, HasEncounterSetView {
    ...
    private static final RectangleEx ENCOUNTER_PORTRAIT_DRAW_REGION = ENCOUNTER_SET_CIRCLE_WEAKNESS_DRAW_REGION.centreOn(PaintConstants.ENCOUNTER_SET_ICON_SIZE).nudgeUp(0.4);
