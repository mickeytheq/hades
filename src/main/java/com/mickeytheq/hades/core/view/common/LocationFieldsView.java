...
public class LocationFieldsView {
    ...
    public static final RectangleEx ENCOUNTER_PORTRAIT_DRAW_REGION = RectangleEx.millimetresHorizontallyCentred(41.60, PaintConstants.ENCOUNTER_SET_ICON_SIZE);
